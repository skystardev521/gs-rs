...
impl Service {
    ...
    fn wan_sproto_id(&mut self, spid: SProtoId, msg: MsgData) {
        match spid {
            ...
            SProtoId::AuthRequest => match self.mucid_route.get_sid(spid as u16, msg.uid) {
                Some(sid) => {
